...
public class NodeMetricsList implements KubernetesResource<NodeMetrics>, KubernetesResourceList<NodeMetrics>
{
    ...
    @JsonProperty("items")
    @JsonPropertyDescription("")
    private List<NodeMetrics> items = new ArrayList<NodeMetrics>();
    /**
     * 
     * (Required)
     * 
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof NodeMetricsList) == false) {
            return false;
        }
        NodeMetricsList rhs = ((NodeMetricsList) other);
